# Autogenerated wrapper script for SDPA_jll for x86_64-w64-mingw32-libgfortran4-cxx11
...
const libsdpa_splitpath = ["bin", "libsdpa-0.dll"]
...
const libsdpa = "libsdpa-0.dll"


# Relative path to `libsdpawrap`
const libsdpawrap_splitpath = ["bin", "libsdpawrap.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libsdpawrap = "libsdpawrap.dll"


# Relative path to `sdpa`
const sdpa_splitpath = ["bin", "sdpa.exe"]

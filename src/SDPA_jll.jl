...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import SDPA_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("7fc90fd6-dbef-5a6a-93f8-169f2a2e705b"))
platforms = [Pkg.Artifacts.unpack_platform(e, "SDPA", artifacts_toml) for e in artifacts["SDPA"]]
...
if best_platform === nothing
    @debug("Unable to load SDPA; unsupported platform $(triplet(platform_key_abi()))")
else
